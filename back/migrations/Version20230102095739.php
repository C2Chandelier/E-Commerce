 ...
 */
final class Version20230102095739 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles ADD reduction VARCHAR(255) DEFAULT NULL, ADD nouveauté TINYINT(1) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE articles DROP reduction, DROP nouveauté');
