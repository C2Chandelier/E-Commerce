 ...
 */
final class Version20221215132545 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE panier_articles (id INT AUTO_INCREMENT NOT NULL, panier_id INT NOT NULL, articles_id INT NOT NULL, quantity INT DEFAULT 1 NOT NULL, INDEX IDX_2598381AF77D927C (panier_id), INDEX IDX_2598381A1EBAF6CC (articles_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
