 ...
 */
final class Version20221215100537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier_articles ADD id INT AUTO_INCREMENT NOT NULL, ADD quantity INT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE panier_articles MODIFY id INT NOT NULL');
        ...
        $this->addSql('DROP INDEX `PRIMARY` ON panier_articles');
        $this->addSql('ALTER TABLE panier_articles DROP id, DROP quantity');
        $this->addSql('ALTER TABLE panier_articles ADD PRIMARY KEY (panier_id, articles_id)');
