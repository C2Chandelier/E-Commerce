...
export default function PaiementVisiteur(){
    ...
    const [fraistotal,setFraistotal] = useState(cookies.get("Frais"));
    
  useEffect(()=>{

    console.log(fraispays)
  },[fraispays])
    ...
    function commande(e){
      ...
      console.log(fraispays+fraislivraison)
        ...
        //console.log("Cookies Frais",cookies.get('Frais'))
