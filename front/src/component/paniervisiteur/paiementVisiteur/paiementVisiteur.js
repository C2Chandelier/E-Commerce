...
export default function PaiementVisiteur() {
  ...
  function retour(){
    setFraistotal(parseFloat(cookies.get('Frais')))
    setLivraison("")
    setFraispays(0)
    setFraislivraison(0)
  }
      ...
      {fraistotal !== parseFloat(cookies.get('Frais')) ?
        ...
        <div>
          ...
          <div id="containerpaiementvisiteur">
            ...
            <div className="icon_wrapperpaiementvisiteur">
              <svg className="iconpaiementvisiteur" viewBox="0 0 145.192 145.192">
            ...
            <form className='formee'>
              ...
              <div className="telephonepaiementvisiteur">
