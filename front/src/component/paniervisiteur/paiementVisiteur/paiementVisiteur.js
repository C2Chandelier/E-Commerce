...
export default function PaiementVisiteur() {
  ...
  return (
    <div>
      ...
      <div id="containerpaiementvisiteur">
        <h1 id='h1paiementvisiteur'>&bull; Paiement &bull;</h1>
        <div class="underline">
        </div>
        <div class="icon_wrapperpaiementvisiteur">
          <svg class="iconpaiementvisiteur" viewBox="0 0 145.192 145.192">
        ...
        <form className='formee'>
          <div class="namepaiementvisiteur">
          ...
          <div class="emailpaiementvisiteur">
          ...
          <div class="telephonepaiementvisiteur">
          ...
          <div onChange={radiochange}>
            ...
            {tariflivraison.map((item) => (
              ...
              <label className='radiopaiementvisiteur' key={item.id}>
                <input name='livraison' type="radio" id="BRadio" value={item.methode}></input>
                <span>{item.methode} {item.prix}€</span>
              </label>
            ))}
          </div>
          <div class="submitpaiementvisiteur">
            <button type="submit" id="form_buttonpaiementvisiteur" onClick={(e) => commande(e)}>Commander</button>
          </div>
        </form>
      </div>
    </div>
